...
class General_normalization:
    ...
    def __init__(self):
        ...
        self.persian_k = {'ك': 'ک', 'ػ': 'ک', 'ؼ': 'ک', 'ڪ': 'ک', 'ګ': 'ک', 'ڬ': 'ک', 'ڭ': 'ک', 'ڮ': 'ک', 'ݢ': 'ک',
                          ...
                          'ﯖ': 'ک', 'ﻙ': 'ک', 'ﻚ': 'ک', 'ﻛ': 'ک', 'ﻜ': 'ک',  'ڪ': 'ک'}

        self.persian_g = {'ڱ': "گ", 'ڰ': 'گ', 'ڱ': 'گ', 'ڲ': 'گ', 'ڳ': 'گ', 'ڴ': 'گ', 'ﮒ': 'گ', 'ﮓ': 'گ', 'ﮔ': 'گ', 'ﮕ': 'گ',
    ...
    def remove_earab(self, sentence):
        for i,j in self.persian_erab.items():
          sentence = sentence.replace(i,j)
        return sentence

  
    #  برای داده  ی ما مناسب نیست مثال: بیطلعتتو جان نگراید بهکالبد
